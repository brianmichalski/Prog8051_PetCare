...
namespace PetManager.Core.Model.Implementation
{
    public class Dog : AbstractAnimal
    {
        ...
        protected override CaringSetup InitializeDefaultCaringSetup()
        {
            ...
            CaringConstraint hydratingConstraint = new CaringConstraint(AnimalNeedEnum.Hydrating, 1, 6, hydratingLimits);
            ...
            CaringConstraint restingConstraint = new CaringConstraint(AnimalNeedEnum.Resting, 2, 4, restingLimits);
